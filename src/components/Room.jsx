					...
					<>
						<header className="page" style={{ marginTop: "0px" }}>
							<div className="container">
								...
								<h1 className="page_title">{list.name}</h1>
							</div>
						</header>
									...
									<div className="room_main-info col-lg-8">
										...
										<div className="description">
											<p className="description_text">
												...
												proin nibh. Ut eu sem integer vitae justo eget magna.
												Scelerisque eleifend donec pretium vulputate sapien nec.
												Blandit aliquam etiam erat velit. Aliquam eleifend mi in
												nulla. Viverra nibh cras pulvinar mattis nunc.
												Adipiscing elit pellentesque habitant morbi tristique
												senectus et netus.
											</p>
											<p className="description_text">
												A diam sollicitudin tempor id eu. Pellentesque eu
												tincidunt tortor aliquam nulla. Non pulvinar neque
											...
											<div className="rules_list d-md-flex flex-lg-wrap">
												<div className="rules_list-block">
													<p className="rules_list-block_item d-flex align-items-baseline">
														<i className="icon-check icon"></i> Time of arrival
														is after 14-00. Time of departure is to 12-00
													</p>
													<p className="rules_list-block_item d-flex align-items-baseline">
														<i className="icon-check icon"></i> Does a
														settlement take place only at complete payment
													</p>
													<p className="rules_list-block_item d-flex align-items-baseline">
														<i className="icon-check icon"></i> Is there a
														settlement in hotel only after the presence of
														passport
													</p>
												</div>
												<div className="rules_list-block">
													<p className="rules_list-block_item d-flex align-items-baseline">
														<i className="icon-check icon"></i> Cum sociis
														natoque penatibus et. Sed elementum tempus egestas
														sed
													</p>
													<p className="rules_list-block_item rules_list-block_item--highlight d-flex align-items-start">
														...
														condimentum. Quam elementum pulvinar etiam non quam
														lacus suspendisse. Eget gravida cum sociis natoque
													</p>
												</div>
											</div>
										</section>
									...
									<label htmlFor="age3">61 - 100</label> */}
										...
										<div className="room_main-cards_card accent">
											...
											<div className="content">
												<p className="text">
													Save up to <b>20%</b> off the nightly rate on stays
													between 7-14 nights
												</p>
												<p className="text">
													Save up to <b>30%</b> off the nightly rate on stays
													between 14-29 nights
												</p>
											</div>
										</div>
									</div>
								...
								<ul className="rooms_list d-md-flex flex-wrap">
									...
									>
										<div className="item-wrapper d-md-flex flex-column">
											...
											<div className="main d-md-flex flex-column justify-content-between flex-grow-1">
												<Link className="main_title h4" to="room">
