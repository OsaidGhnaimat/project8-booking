...
import "./assest/css/room.min.css";
...
export default function Room() {
	...
	return (
		...
		<header className="page" style={{ marginTop: "0px" }}>
			<div className="container">
				<ul className="breadcrumbs d-flex flex-wrap align-content-center">
					...
					<li className="list-item">
						<a className="link" href="rooms.html">
							Rooms
						</a>
					</li>
					<li className="list-item">
				...
				<h1 className="page_title">Superior Double Bed Private Ensuite</h1>
			</div>
		</header>
		<div className="room section">
			<div className="container">
				<div className="room_main d-lg-flex flex-wrap align-items-start">
					<div className="room_main-slider col-12 d-lg-flex">
						<div className="room_main-slider_view col-lg-8 swiper-fade swiper-initialized swiper-horizontal swiper-pointer-events">
							<div
							...
							>
								...
								<div
									...
									style={{
										width: "764px",
										opacity: "1",
										transhtmlForm: "translate3d(-764px, 0px, 0px)",
										transitionDuration: " 0ms",
									}}
								>
									<img
										className="lazy entered error"
										data-src="img/room/01.jpg"
										src="img/room/01.jpg"
										alt="media"
								...
								<div
									...
									style={{
										width: "764px",
										opacity: "1",
										transhtmlForm: "translate3d(-1528px, 0px, 0px)",
										transitionDuration: " 0ms",
									}}
								>
									<img
										className="lazy entered error"
										data-src="img/room/02.jpg"
										src="img/room/02.jpg"
										alt="media"
										data-ll-status="error"
									/>
								...
								<div
									...
									style={{
										width: "764px",
										opacity: "1",
										transhtmlForm: "translate3d(-2292px, 0px, 0px)",
										transitionDuration: " 0ms",
									}}
								>
									<img
								...
								<div
									...
									style={{
										width: "764px",
										opacity: "1",
										transhtmlForm: "translate3d(-3056px, 0px, 0px)",
										transitionDuration: " 0ms",
									}}
								>
									<img
						...
						<div className="room_main-slider_thumbs swiper-initialized swiper-pointer-events swiper-vertical">
							<div
								className="swiper-wrapper"
								style={{
									transhtmlForm: "translate3d(0px, -1140px, 0px)",
									transitionDuration: "0ms",
								}}
							>
								<div
									...
									data-swiper-slide-index="1"
									style={{ height: "255px", marginBottom: "30px" }}
								>
									<img
										className="lazy"
										data-src="img/room/02.jpg"
					...
					<div className="room_main-info col-lg-8">
						...
						<div className="description">
							<p className="description_text">
								Bibendum est ultricies integer quis auctor elit sed. Mattis
								pellentesque id nibh tortor id aliquet lectus proin nibh. Ut
								eu sem integer vitae justo eget magna. Scelerisque eleifend
								donec pretium vulputate sapien nec. Blandit aliquam etiam erat
								velit. Aliquam eleifend mi in nulla. Viverra nibh cras
								pulvinar mattis nunc. Adipiscing elit pellentesque habitant
								morbi tristique senectus et netus.
							</p>
							<p className="description_text">
								A diam sollicitudin tempor id eu. Pellentesque eu tincidunt
								tortor aliquam nulla. Non pulvinar neque laoreet suspendisse
								interdum consectetur libero id faucibus.
							</p>
						</div>
						<section className="facilities">
							<h4 className="facilities_header">Room facilities</h4>
							<div className="facilities_list d-sm-flex flex-wrap">
								<div className="facilities_list-block">
									<span className="facilities_list-block_item d-flex align-items-center">
										<span className="icon">
											<svg
												width="32"
												height="32"
							...
							<div className="rules_list d-md-flex flex-lg-wrap">
								<div className="rules_list-block">
									<p className="rules_list-block_item d-flex align-items-baseline">
										<i className="icon-check icon"></i> Time of arrival is
										after 14-00. Time of departure is to 12-00
									</p>
									<p className="rules_list-block_item d-flex align-items-baseline">
										<i className="icon-check icon"></i> Does a settlement take
										place only at complete payment
									</p>
									<p className="rules_list-block_item d-flex align-items-baseline">
								...
								<div className="rules_list-block">
									<p className="rules_list-block_item d-flex align-items-baseline">
										<i className="icon-check icon"></i> Cum sociis natoque
										penatibus et. Sed elementum tempus egestas sed
									</p>
									<p className="rules_list-block_item rules_list-block_item--highlight d-flex align-items-start">
										<i className="icon-check icon"></i> Volutpat odio
					...
					<div className="room_main-cards col-lg-4">
						<div className="room_main-cards_card">
							<form
								className="booking"
								method="post"
								autoComplete="off"
							...
							>
								<div className="booking_group d-flex flex-column">
									...
									<br />
									<input value={time} onChange={Time} placeholder="time" name="time" type="time"/>
						...
						<div className="room_main-cards_card accent">
							...
							<div className="content">
								...
								<p className="text">
									Save up to <b>30%</b> off the nightly rate on stays between
									14-29 nights
								</p>
							</div>
						</div>
		...
		<section className="rooms section--blockbg section">
			<div className="block"></div>
			<div className="container">
				<div className="rooms_header d-sm-flex justify-content-between align-items-center">
					<h2 className="rooms_header-title aos-init">Other rooms</h2>
					<div className="wrapper aos-init">
						<a
				...
				<ul className="rooms_list d-md-flex flex-wrap">
					<li
						className="rooms_list-item col-md-6 col-xl-4 aos-init"
						data-order="1"
					>
					...
					>
						<div className="item-wrapper d-md-flex flex-column">
							<div className="media">
								<img
									className="lazy"
									data-src="img/about/02.jpg"
									src="img/about/02.jpg"
									alt="media"
								/>
								<span className="media_label media_label--pricing">
									<span className="price h4">$35</span> / 1 night
								</span>
							</div>
							<div className="main d-md-flex flex-column justify-content-between flex-grow-1">
								<a
					...
					>
						<div className="item-wrapper d-md-flex flex-column">
							<div className="media">
								<img
									className="lazy"
									data-src="img/about/03.jpg"
									src="img/about/03.jpg"
									alt="media"
								/>
								<span className="media_label media_label--pricing">
									<span className="price h4">$99</span> / 1 night
								</span>
							</div>
							<div className="main d-md-flex flex-column justify-content-between flex-grow-1">
