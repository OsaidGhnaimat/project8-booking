<html lang="en">
   <head>
      ...
      <link rel="stylesheet" href="css/hostel.min.css">
   </head>
   <body>
      <header class="header d-flex align-items-center headroom headroom--not-bottom header--pinned headroom--top">
         <div class="container position-relative d-flex justify-content-between align-items-center">
            <a class="brand d-flex align-items-center" href="index.html">
               ...
               <span class="brand_name">Taksim</span>

            </a>
            <div class="header_offcanvas" id="menuOffcanvas" style="visibility: visible;">
               <div class="header_offcanvas-header d-flex justify-content-between align-content-center">
                  ...
                  <button class="close" type="button" data-bs-dismiss="offcanvas"><i
                     class="icon-close--entypo"></i></button>
               </div>
               <nav class="header_nav">
                  <ul class="header_nav-list">
                     ...
                     <li class="header_nav-list_item">
                        <a class="nav-link dropdown-toggle d-inline-flex align-items-center" href="hostel.html">
                        Hostel <i class="icon-chevron_down--entypo icon"></i>
                        </a>
                     </li>
                     <li class="list-item"><a class="dropdown-item nav-item" href="gallery.html">Gallery</a></li>
                     <li class="header_nav-list_item">
            ...
            <button class="header_trigger d-lg-none" type="button"><i class="icon-stream"></i></button>
         </div>
      </header>
      <header class="page" style="margin-top: 0px;">
         <div class="container">
      ...
      <main class="rooms section">
         <div class="container">
            <ul class="rooms_list">
               <li class="rooms_list-item aos-init aos-animate" data-order="1" data-aos="fade-up">
                  <div class="item-wrapper d-md-flex">
                     <div class="media">
                        <img class="lazy entered error" data-src="img/rooms/01.jpg" src="img/rooms/01.jpg"
                           alt="media" data-ll-status="error">
                     </div>
                     <div class="main d-md-flex justify-content-between">
                        <div class="main_info d-md-flex flex-column justify-content-between">
                           ...
                           <p class="main_description">Diam phasellus vestibulum lorem sed risus ultricies
                              tristique.
                           </p>
                           <div class="main_amenities"><span
                              ...
                              class="main_amenities-item d-inline-flex align-items-center"><i
                              class="icon-bunk_bed icon"></i> 1 bunk bed</span></div>
                        </div>
                        <div class="main_pricing d-flex flex-column align-items-md-end justify-content-md-between">
                           <div class="wrapper d-flex flex-column"><span class="main_pricing-item"><span
                              class="h2">$29</span> / 1 night </span><span class="main_pricing-item"><span
                              class="h4">$100</span> / 7 nights</span></div>
                           <a class="theme-element theme-element--accent btn" href="#">Book now</a>
                        </div>
                     </div>
                  </div>
               </li>
               <li class="rooms_list-item aos-init aos-animate" data-order="2" data-aos="fade-up">
                  <div class="item-wrapper d-md-flex">
                     <div class="media">
                        <img class="lazy entered error" data-src="img/rooms/02.jpg" src="img/rooms/02.jpg"
                           alt="media" data-ll-status="error">
                     </div>
                     <div class="main d-md-flex justify-content-between">
                        <div class="main_info d-md-flex flex-column justify-content-between">
                        ...
                        <div class="main_pricing d-flex flex-column align-items-md-end justify-content-md-between">
                           <div class="wrapper d-flex flex-column"><span class="main_pricing-item"><span
                              class="h2">$19</span> / 1 night </span><span class="main_pricing-item"><span
                              class="h4">$80</span> / 7 nights</span></div>
                           <a class="theme-element theme-element--accent btn" href="#">Book now</a>
                        </div>
                     </div>
                  </div>
               </li>
               <li class="rooms_list-item aos-init aos-animate" data-order="3" data-aos="fade-up">
                  <div class="item-wrapper d-md-flex">
                     <div class="media">
                        <img class="lazy entered error" data-src="img/rooms/03.jpg" src="img/rooms/03.jpg"
                           alt="media" data-ll-status="error">
                     </div>
                     <div class="main d-md-flex justify-content-between">
                        <div class="main_info d-md-flex flex-column justify-content-between">
                           <a class="main_title h4" href="room.html">Comfort Superior Double Bed Private
                           Ensuite</a>
                           <p class="main_description">Diam phasellus vestibulum lorem sed risus ultricies
                              tristique.
                           </p>
                           <div class="main_amenities"><span
                              class="main_amenities-item d-inline-flex align-items-center"><i
                              class="icon-user icon"></i> 3 Sleeps </span><span
                              class="main_amenities-item d-inline-flex align-items-center"><i
                              class="icon-twin_bed icon"></i> 1 full bed </span><span
                              class="main_amenities-item d-inline-flex align-items-center"><i
                              class="icon-bunk_bed icon"></i> 1 twin bed</span></div>
                        </div>
                        <div class="main_pricing d-flex flex-column align-items-md-end justify-content-md-between">
                           <div class="wrapper d-flex flex-column"><span class="main_pricing-item"><span
                              class="h2">$99</span> / 1 night </span><span class="main_pricing-item"><span
                              class="h4">$220</span> / 7 nights</span></div>
                           <a class="theme-element theme-element--accent btn" href="#">Book now</a>
                        </div>
                     </div>
                  </div>
               </li>
               <li class="rooms_list-item aos-init aos-animate" data-order="4" data-aos="fade-up">
                  <div class="item-wrapper d-md-flex">
                     <div class="media">
                        <img class="lazy entered error" data-src="img/rooms/04.jpg" src="img/rooms/04.jpg"
                           alt="media" data-ll-status="error">
                     </div>
                     <div class="main d-md-flex justify-content-between">
                        <div class="main_info d-md-flex flex-column justify-content-between">
                           ...
                           <div class="main_amenities"><span
                              ...
                              class="icon-user icon"></i> 2 Sleeps </span><span
                              class="main_amenities-item d-inline-flex align-items-center"><i
                              class="icon-twin_bed icon"></i> 2 twin beds</span></div>
                        </div>
                        <div class="main_pricing d-flex flex-column align-items-md-end justify-content-md-between">
                           <div class="wrapper d-flex flex-column"><span class="main_pricing-item"><span
                              class="h2">$29</span> / 1 night </span><span class="main_pricing-item"><span
                              class="h4">$115</span> / 7 nights</span></div>
                           <a class="theme-element theme-element--accent btn" href="#">Book now</a>
                        </div>
                     </div>
                  </div>
               </li>
               <li class="rooms_list-item aos-init aos-animate" data-order="5" data-aos="fade-up">
                  <div class="item-wrapper d-md-flex">
                     <div class="media">
                        <img class="lazy entered error" data-src="img/rooms/05.jpg" src="img/rooms/05.jpg"
                           alt="media" data-ll-status="error">
                     </div>
                     <div class="main d-md-flex justify-content-between">
                        <div class="main_info d-md-flex flex-column justify-content-between">
                           <a class="main_title h4" href="room.html">Standard Double Bed Private Shared
                           Bathroom</a>
                           <p class="main_description">Diam phasellus vestibulum lorem sed risus ultricies
                              tristique.
                           </p>
                           <div class="main_amenities"><span
                              ...
                              class="icon-twin_bed icon"></i> 1 full bed </span><span
                              class="main_amenities-item d-inline-flex align-items-center"><i
                              class="icon-sofa icon"></i> 2 sofa beds</span></div>
                        </div>
                        <div class="main_pricing d-flex flex-column align-items-md-end justify-content-md-between">
                           <div class="wrapper d-flex flex-column"><span class="main_pricing-item"><span
                              class="h2">$59</span> / 1 night </span><span class="main_pricing-item"><span
                              class="h4">$210</span> / 7 nights</span></div>
                           <a class="theme-element theme-element--accent btn" href="#">Book now</a>
                        </div>
                     </div>
                  </div>
      ...
      <footer class="footer accent">
         <div class="container">
            <div class="footer_main d-sm-flex flex-wrap flex-lg-nowrap justify-content-between">
               <div class="footer_main-block footer_main-block--about col-sm-7 col-lg-auto d-flex flex-column">
                  <a class="brand d-flex align-items-center" href="index.html">
                     <span class="brand_logo theme-element">
                        <svg id="brandFooter" width="22" height="23" viewBox="0 0 22 23" fill="none"
                           xmlns="http://www.w3.org/2000/svg">
                           <path fillRule="evenodd" clipRule="evenodd"
                              d="M7.03198 3.80281V7.07652L3.86083 9.75137L0.689673 12.4263L0.667474 6.56503C0.655304 3.34138 0.663875 0.654206 0.686587 0.593579C0.71907 0.506918 1.4043 0.488223 3.87994 0.506219L7.03198 0.529106V3.80281ZM21.645 4.36419V5.88433L17.0383 9.76316C14.5046 11.8966 11.2263 14.6552 9.75318 15.8934L7.07484 18.145V20.3225V22.5H3.85988H0.64502L0.667303 18.768L0.689673 15.036L2.56785 13.4609C3.60088 12.5946 6.85989 9.85244 9.81009 7.36726L15.1741 2.84867L18.4096 2.8464L21.645 2.84413V4.36419ZM21.645 15.5549V22.5H18.431H15.217V18.2638V14.0274L15.4805 13.7882C15.8061 13.4924 21.5939 8.61606 21.6236 8.61248C21.6353 8.61099 21.645 11.7351 21.645 15.5549Z"
                              fill="currentColor"></path>
               ...
               <div class="footer_main-block footer_main-block--nav col-sm-6 col-lg-auto">
                  ...
                  <ul class="footer_main-block_nav d-flex flex-lg-column">
                     ...
                     <li class="list-item"><a class="link underlined underlined--white nav-item" data-page="about"
                        href="hostel.html">Hostel</a></li>
                     <li class="list-item"><a class="link underlined underlined--white nav-item"
                  ...
                  <ul class="footer_main-block_contacts">
                     ...
                     <li class="list-item d-flex">
                        ...
                        <p class="wrapper d-flex flex-column"><a class="link" href="tel:+1234567890">(329)
                           580-7077</a> <a class="link" href="tel:+1234567890">(650) 382-5020</a>
                        </p>
                     </li>
                  </ul>
               </div>
         ...
         <div class="footer_copyright">
            <div class="container">
               <p class="footer_copyright-text"><span class="linebreak">Merkulove © Hosteller Template</span> <span
