...
<main>
        ...
        <div className='container'>
            <ul className="breadcrumbs d-flex flex-wrap align-content-center">
                <li className='list-item'><a className='link' href='index-2.html'>Home</a></li>
                <li className='list-item'><a className='link' href='#'>Photo Gallery of Our hotel</a></li>
            </ul>
            ...
            <div className='container'>
                ...
                <div className="gallery_masonry row g-0">
                    ...
                    <figure className="gallery_masonry-item col-sm-6 col-lg-4" data-groups='["standard", "apartment"]'>
                        <a className="aspect aspect--sm" href='img/gallery/full02.jpg' data-caption="Image caption"
                            data-role='gallery-link'>
                            <div className='aspect__inner'>
                                <img className="gallery_masonry-item_img lazy" data-src='img/gallery/full02.jpg'
