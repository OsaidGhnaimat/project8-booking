...
<head>
    <link rel="stylesheet preload" as=style href=css/preload.min.css> <link rel="stylesheet preload" as=style
        href=css/libs.min.css> <link rel=stylesheet href=css/gallery.min.css> </head> <body>
            ...
            <div class=container>
                ...
                <div class="gallery_masonry row g-0">
                    ...
                    <figure class="gallery_masonry-item col-sm-6 col-lg-4" data-groups='["kitchen", "apartment"]'>
                        <a class="aspect aspect--sm" href=img/gallery/full06.jpg data-caption="Image caption"
                            data-role=gallery-link>
                            <div class=aspect__inner>
                                <img class="gallery_masonry-item_img lazy" data-src=img/gallery/full06.jpg
                    ...
                    <figure class="gallery_masonry-item col-sm-6 col-lg-4" data-groups='["standard", "apartment"]'>
                        <a class=aspect href=img/gallery/full07.jpg data-caption="Image caption" data-role=gallery-link>
                            <div class=aspect__inner>
                                <img class="gallery_masonry-item_img lazy" data-src=img/gallery/full07.jpg
                    ...
                    <figure class="gallery_masonry-item col-sm-6 col-lg-4" data-groups='["living", "apartment"]'>
                        <a class="aspect aspect--sm" href=img/gallery/full08.jpg data-caption="Image caption"
                            data-role=gallery-link>
                            <div class=aspect__inner>
                                <img class="gallery_masonry-item_img lazy" data-src=img/gallery/full08.jpg
                    ...
                    <figure class="gallery_masonry-item col-sm-6 col-lg-4" data-groups='["standard", "apartment"]'>
                        <a class=aspect href=img/gallery/full09.jpg data-caption="Image caption" data-role=gallery-link>
                            <div class=aspect__inner>
                                <img class="gallery_masonry-item_img lazy" data-src=img/gallery/full09.jpg
                    ...
                    <figure class="gallery_masonry-item col-sm-6 col-lg-4" data-groups='["kitchen"]'>
                        <a class=aspect href=img/gallery/full11.jpg data-caption="Image caption" data-role=gallery-link>
                            <div class=aspect__inner>
                                <img class="gallery_masonry-item_img lazy" data-src=img/gallery/full11.jpg
                    ...
                    <figure class="gallery_masonry-item col-sm-6 col-lg-4" data-groups='["kitchen", "living"]'>
                        <a class="aspect aspect--sm" href=img/gallery/full10.jpg data-caption="Image caption"
                            data-role=gallery-link>
                            <div class=aspect__inner>
                                <img class="gallery_masonry-item_img lazy" data-src=img/gallery/full10.jpg
                    ...
                    <figure class="gallery_masonry-item col-sm-6 col-lg-4" data-groups='["kitchen"]'>
                        <a class="aspect aspect--sm" href=img/gallery/full12.jpg data-caption="Image caption"
                            data-role=gallery-link>
                            <div class=aspect__inner>
                                <img class="gallery_masonry-item_img lazy" data-src=img/gallery/full12.jpg
    ...
    <script src=js/gallery.min.js> </script> </html> </body>