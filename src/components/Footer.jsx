		...
		<footer className="footer accent">
			<div className="container">
				<div className="footer_main d-sm-flex flex-wrap flex-lg-nowrap justify-content-between">
					...
					<div className="footer_main-block footer_main-block--contacts col-sm-5 col-lg-auto">
						<h4 className="footer_main-block_header">Contact Us</h4>
						<ul className="footer_main-block_contacts">
