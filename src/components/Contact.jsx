   ...
   <body>
      <header class="header d-flex align-items-center headroom headroom--not-bottom header--pinned headroom--top">
         <div class="container position-relative d-flex justify-content-between align-items-center">
            ...
            <div class="header_offcanvas" id="menuOffcanvas" style="visibility: visible;">
               ...
               <nav class="header_nav">
                  <ul class="header_nav-list">
                     ...
                     <li class="list-item"><a class="dropdown-item nav-item"
            ...
            <button class="header_trigger d-lg-none" type="button"
               ><i class="icon-stream"></i></button>
         </div>
      </header>
      <header class="page" style="margin-top: 80px;">
         <div class="container">
            ...
            <div class="container container--contacts d-xl-flex align-items-center justify-content-between">
               <div class="contacts_info">
                  <div class="contacts_info-header">
                     <h2 class="contacts_info-header_title aos-init aos-animate" data-aos="fade-down">Contacts</h2>
                     <p class="contacts_info-header_text aos-init aos-animate" data-aos="fade-up">Egestas pretium
                        aenean pharetra magna ac. Et tortor consequat id porta nibh venenatis cras sed
                     </p>
                  </div>
                  <ul class="contacts_info-list col-xl-7 d-md-flex flex-wrap">
                     <li class="contacts_info-list_item col-md-6 d-flex align-items-center aos-init aos-animate"
                        >
                        ...
                        <div class="main d-flex flex-column">
                           ...
                           <a class="link" href="tel:+1234567890">(329) 580-7077</a> <a class="link"
                              href="tel:+1234567890">(650) 382-5020</a>
                        </div>
                     </li>
                     <li class="contacts_info-list_item col-md-6 d-flex align-items-center aos-init aos-animate"
                        >
                        <span class="theme-element theme-element--light media"><i
                           class="icon-email icon"></i></span>
                        <div class="main d-flex flex-column">
                           <h4 class="main_title">Email</h4>
                           <a class="link"
                              href="../cdn-cgi/l/email-protection.html#14716c757964787154707b79757d7a3a777b79"><span
                              class="__cf_email__"
                              data-cfemail="b5d6dadbc1d4d6c1f5d0cdd4d8c5d9d09bd6dad8">[email&nbsp;protected]</span></a>
                           <a class="link"
                              href="../cdn-cgi/l/email-protection.html#711409101c011d1431151e1c10181f5f121e1c"><span
                              class="__cf_email__"
                              data-cfemail="53303c3d2732302713362b323e233f367d303c3e">[email&nbsp;protected]</span></a>
                        </div>
                     </li>
                     <li class="contacts_info-list_item col-md-6 d-flex align-items-center aos-init aos-animate"
                        >
                        ...
                        <div class="main d-flex flex-column">
                           ...
                           <span>54826 Fadel Circles</span> <span>Darrylstad, AZ 90995</span>
                        </div>
                     </li>
                     <li class="contacts_info-list_item col-md-6 d-flex align-items-center aos-init aos-animate" >
                        <span class="theme-element theme-element--light media"><i
               ...
               <div class="contacts_map">
                  <img class="lazy" src="img/about/01.jpg" alt="media">
               </div>
            </div>
         </section>
               ...
               <div class="about_faq-main d-grid">
                  <div class="accordion_component-item">
                     <div class="item-wrapper d-flex flex-column justify-content-between">
                        <h4 class="accordion_component-item_header d-flex justify-content-between align-items-center collapsed"
                           >How do you
                           choose the right hostel? <span class="wrapper"><i
                              class="icon-chevron_down icon transform"></i></span>
                        </h4>
                  ...
                  <div class="accordion_component-item">
                     <div class="item-wrapper d-flex flex-column justify-content-between">
                        <h4 class="accordion_component-item_header d-flex justify-content-between align-items-center"
                           >How many people
                           are in a hostel room? <span class="wrapper"><i
                              class="icon-chevron_down icon transform"></i></span>
                        </h4>
                  ...
                  <div class="accordion_component-item">
                     <div class="item-wrapper d-flex flex-column justify-content-between">
                        <h4 class="accordion_component-item_header d-flex justify-content-between align-items-center collapsed"
                           >Are there
                           private rooms in Hostels? <span class="wrapper"><i
                              class="icon-chevron_down icon transform"></i></span>
                        </h4>
                  ...
                  <div class="accordion_component-item">
                     <div class="item-wrapper d-flex flex-column justify-content-between">
                        <h4 class="accordion_component-item_header d-flex justify-content-between align-items-center collapsed"
                           data-bs-toggle="collapse" data-bs-target="#item-5" aria-expanded="true">How do you stay
                           safe in a hostel? <span class="wrapper"><i
                              class="icon-chevron_down icon transform"></i></span>
                        </h4>
                  ...
                  <div class="about_faq-main_card accent d-flex flex-column justify-content-between">
                     ...
                     <a class="btn theme-element theme-element--light" href="contact.html">Ask a question</a>
                  </div>
               </div>
            </div>
         </section>
