            ...
            764: function (e) {
                e.exports = function () {
                    ...
                    const e = Object.freeze({
                        ...
                        H = () => {
                            const e = i(S().querySelectorAll('[tabindex]:not([tabindex="-1"]):not([tabindex="0"])')).sort(((e, t) => (e = parseInt(e.getAttribute("tabindex"))) > (t = parseInt(t.getAttribute("tabindex"))) ? 1 : e < t ? -1 : 0)),
                        ...
                        ve = () => {
                            const e = S(),
                                ...
                                a = te(e, w.textarea);
                            t.oninput = ge, n.onchange = ge, r.onchange = ge, o.onchange = ge, a.oninput = ge, s.oninput = () => {
                                ge(), i.value = s.value
                            }, s.onchange = () => {
                    ...
                    function Oe(e, t, n) {
                        const s = L(),
                            i = B(),
                            r = j();
                        Me(s, "confirm", n), Me(i, "deny", n), Me(r, "cancel", n), Ae(s, i, r, n), n.reverseButtons && (n.toast ? (e.insertBefore(r, s), e.insertBefore(i, s)) : (e.insertBefore(r, t), e.insertBefore(i, t), e.insertBefore(s, t)))
                    }
                    ...
                    function Me(e, t, n) {
                        oe(e, n["show".concat(s(t), "Button")], "inline-block"), W(e, n["".concat(t, "ButtonText")]), e.setAttribute("aria-label", n["".concat(t, "ButtonAriaLabel")]), e.className = w[t], X(e, n, "".concat(t, "Button")), Q(e, n["".concat(t, "ButtonClass")])
                    }
                    ...
                    Re.text = Re.email = Re.password = Re.number = Re.tel = Re.url = (e, t) => ("string" == typeof t.inputValue || "number" == typeof t.inputValue ? e.value = t.inputValue : m(t.inputValue) || r('Unexpected type of inputValue! Expected "string", "number" or "Promise", got "'.concat(typeof t.inputValue, '"')), Ve(e, e, t), Ge(e, t), e.type = t.input, e), Re.file = (e, t) => (Ve(e, e, t), Ge(e, t), e), Re.range = (e, t) => {
                        ...
                        return Ve(e, e, t), e
                    }, Re.radio = e => (e.textContent = "", e), Re.checkbox = (e, t) => {
                    ...
                    const We = (e, t) => {
                        ...
                        Xe = (e, t) => {
                            const n = je.innerParams.get(e),
                                s = E();
                            return n && t.icon === n.icon ? (Je(s, t), void Ke(s, t)) : t.icon || t.iconHtml ? t.icon && -1 === Object.keys(y).indexOf(t.icon) ? (o('Unknown icon! Expected "success", "error", "warning", "info" or "question", got "'.concat(t.icon, '"')), ie(s)) : (se(s), Je(s, t), Ke(s, t), void Q(s, t.showClass.icon)) : ie(s)
                        },
                        Ke = (e, t) => {
                        ...
                        it = (e, t) => {
                            ...
                            se(n), n.textContent = "", t.currentProgressStep >= t.progressSteps.length && r("Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"), t.progressSteps.forEach(((e, s) => {
                                const i = nt(e);
                        ...
                        ot = (e, t) => {
                            const n = C(),
                                s = S();
                            t.toast ? (ne(n, "width", t.width), s.style.width = "100%", s.insertBefore(I(), E())) : ne(s, "width", t.width), ne(s, "padding", t.padding), t.color && (s.style.color = t.color), t.background && (s.style.background = t.background), ie(M()), at(s, t)
                        },
                        at = (e, t) => {
                    ...
                    const Mt = e => {
                        ...
                        Bt = ["allowEscapeKey", "allowOutsideClick", "background", "buttonsStyling", "cancelButtonAriaLabel", "cancelButtonColor", "cancelButtonText", "closeButtonAriaLabel", "closeButtonHtml", "color", "confirmButtonAriaLabel", "confirmButtonColor", "confirmButtonText", "currentProgressStep", "customClass", "denyButtonAriaLabel", "denyButtonColor", "denyButtonText", "didClose", "didDestroy", "footer", "hideClass", "html", "icon", "iconColor", "iconHtml", "imageAlt", "imageHeight", "imageUrl", "imageWidth", "preConfirm", "preDeny", "progressSteps", "returnFocus", "reverseButtons", "showCancelButton", "showCloseButton", "showConfirmButton", "showDenyButton", "text", "title", "titleText", "willClose"],
                        $t = {},
                    ...
                    function Vt() {
                        ...
                        ie(t.loader), V() ? e.icon && se(E()) : Ft(t), ee([t.popup, t.actions], w.loading), t.popup.removeAttribute("aria-busy"), t.popup.removeAttribute("data-loading"), t.confirmButton.disabled = !1, t.denyButton.disabled = !1, t.cancelButton.disabled = !1
                    }
                    const Ft = e => {
                    ...
                    function rn(e, t, n, s) {
                        V() ? fn(e, s) : (yt(n).then((() => fn(e, s))), bt.keydownTarget.removeEventListener("keydown", bt.keydownHandler, {
                            capture: bt.keydownListenerCapture
                        }), bt.keydownHandlerAdded = !1), /^((?!chrome|android).)*safari/i.test(navigator.userAgent) ? (t.setAttribute("style", "display:none !important"), t.removeAttribute("class"), t.innerHTML = "") : t.remove(), G() && (Yt(), en(), nn()), on()
                    }
                    ...
                    const un = e => {
                        ...
                        hn = (e, t, n, s, i) => {
                            bt.swalCloseEventFinishedCallback = rn.bind(null, e, n, s, i), t.addEventListener(Ee, (function (e) {
                    ...
                    function Pn(e) {
                        e.inputValidator || Object.keys(kn).forEach((t => {
                    ...
                    function An(e) {
                        Pn(e), e.showLoaderOnConfirm && !e.preConfirm && r("showLoaderOnConfirm is set to true, but preConfirm is not defined.\nshowLoaderOnConfirm should be used together with preConfirm, see usage example:\nhttps://sweetalert2.github.io/#ajax-request"), On(e), "string" == typeof e.title && (e.title = e.title.split("\n").join("<br />")), Ce(e)
                    }
                    const Mn = ["swal-title", "swal-html", "swal-footer"],
                        ...
                        _n = e => {
                            ...
                            i(e.children).forEach((e => {
                                const n = e.tagName.toLowerCase(); - 1 === t.indexOf(n) && r("Unrecognized element <".concat(n, ">"))
                            }))
                        },
                        Nn = (e, t) => {
                        ...
                        Hn = e => {
                            ...
                            Rn(t, n, e), setTimeout((() => {
                                Vn(t, n)
                            }), qn), G() && (Fn(t, e.scrollbarPadding, s), tn()), V() || bt.previousActiveElement || (bt.previousActiveElement = document.activeElement), "function" == typeof e.didOpen && setTimeout((() => e.didOpen(n))), ee(t, w["no-transition"])
                        },
                        Gn = e => {
                            const t = S();
                        ...
                        Rn = (e, t, n) => {
                            ...
                            }), qn), Q([document.documentElement, document.body], w.shown), n.heightAuto && n.backdrop && !n.toast && Q([document.documentElement, document.body], w["height-auto"])
                        },
                        Wn = (e, t) => {
                        ...
                        Zn = (e, t) => {
                            ...
                            u(t.inputOptions) || m(t.inputOptions) ? (ft(L()), p(t.inputOptions).then((t => {
                                e.hideLoading(), s(t)
                        ...
                        as = (e, t) => {
                            ...
                            n.showLoaderOnDeny && ft(B()), n.preDeny ? (je.awaitingPromise.set(e || void 0, !0), Promise.resolve().then((() => p(n.preDeny(t, n.validationMessage)))).then((n => {
                                !1 === n ? e.hideLoading() : e.closePopup({
                                    isDenied: !0,
                                    value: void 0 === n ? t : n
                                })
                            })).catch((t => cs(e || void 0, t)))) : e.closePopup({
                                isDenied: !0,
                                value: t
                            })
                        },
                        ...
                        ds = (e, t) => {
                            const n = je.innerParams.get(e || void 0);
                            n.showLoaderOnConfirm && ft(), n.preConfirm ? (e.resetValidationMessage(), je.awaitingPromise.set(e || void 0, !0), Promise.resolve().then((() => p(n.preConfirm(t, n.validationMessage)))).then((n => {
                                ae(M()) || !1 === n ? e.hideLoading() : ls(e, void 0 === n ? t : n)
                            })).catch((t => cs(e || void 0, t)))) : ls(e, t)
                        },
                        us = (e, t, n, s) => {
                            t.keydownTarget && t.keydownHandlerAdded && (t.keydownTarget.removeEventListener("keydown", t.keydownHandler, {
                                capture: t.keydownListenerCapture
                            }), t.keydownHandlerAdded = !1), n.toast || (t.keydownHandler = t => fs(e, t, s), t.keydownTarget = n.keydownListenerCapture ? window : S(), t.keydownListenerCapture = n.keydownListenerCapture, t.keydownTarget.addEventListener("keydown", t.keydownHandler, {
                                capture: t.keydownListenerCapture
                    ...
                    const Ps = (e, t) => {
                        ...
                        Os = (t, n, s) => new Promise(((i, r) => {
                            ...
                            sn.swalPromiseResolve.set(t, i), sn.swalPromiseReject.set(t, r), n.confirmButton.onclick = () => ns(t), n.denyButton.onclick = () => ss(t), n.cancelButton.onclick = () => is(t, o), n.closeButton.onclick = () => o(e.close), ys(t, n, o), us(t, bt, s, o), Wn(t, s), Hn(s), Ms(bt, s, o), Ls(n, s), setTimeout((() => {
                        ...
                        Bs = (e, t) => t.focusDeny && ae(e.denyButton) ? (e.denyButton.focus(), !0) : t.focusCancel && ae(e.cancelButton) ? (e.cancelButton.focus(), !0) : !(!t.focusConfirm || !ae(e.confirmButton) || (e.confirmButton.focus(), 0)),
                        $s = () => {
                    ...
                    function Is(e) {
                        ...
                        Object.keys(e).forEach((t => {
                            Gs.isUpdatableParameter(t) ? s[t] = e[t] : r('Invalid parameter to update: "'.concat(t, '". Updatable params are listed here: https://github.com/sweetalert2/sweetalert2/blob/master/src/utils/params.js\n\nIf you think this parameter should be updatable, request it here: https://github.com/sweetalert2/sweetalert2/issues/new?template=02_feature_request.md'))
                        }));
                        const i = Object.assign({}, n, s);
                        lt(this, i), je.innerParams.set(this, i), Object.defineProperties(this, {
                            params: {
                    ...
                    function js() {
                        ...
                        t ? (e.popup && bt.swalCloseEventFinishedCallback && (bt.swalCloseEventFinishedCallback(), delete bt.swalCloseEventFinishedCallback), bt.deferDisposalTimer && (clearTimeout(bt.deferDisposalTimer), delete bt.deferDisposalTimer), "function" == typeof t.didDestroy && t.didDestroy(), Ds(this)) : zs(this)
                    }
                    const Ds = e => {
                    ...
                    Object.assign(Hs.prototype, Ns), Object.assign(Hs, Gt), Object.keys(Ns).forEach((e => {
                        Hs[e] = function () {
                            if (qs) return qs[e](...arguments)
                        }
                    })), Hs.DismissReason = e, Hs.version = "11.3.0";
                    const Gs = Hs;
    ...
    n.n = e => {
        ...
        function k(e = {}) {
            return T || (T = function ({
                ...
                const u = i.match(/(iPod)(.*OS\s([\d_]+))?/),
                    ...
                    m = "Win32" === s;
                let h = "MacIntel" === s;
                return !d && h && t.touch && ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(`${a}x${l}`) >= 0 && (d = i.match(/(Version)\/([\d.]+)/), d || (d = [0, 1, "13_0_0"]), h = !1), c && !m && (r.os = "android", r.android = !0), (d || p || u) && (r.os = "ios", r.ios = !0), r
            }(e)), T
        }
        ...
        const A = {
            ...
            updateClickedSlide: function (e) {
                ...
                t.clickedSlide = s, t.virtual && t.params.virtual.enabled ? t.clickedIndex = parseInt(h(s).attr("data-swiper-slide-index"), 10) : t.clickedIndex = i, n.slideToClickedSlide && void 0 !== t.clickedIndex && t.clickedIndex !== t.activeIndex && t.slideToClickedSlide()
            }
        };
        const M = {
        ...
        const B = {
            ...
            slidePrev: function (e = this.params.speed, t = !0, n) {
                ...
                let h = 0;
                return void 0 !== m && (h = a.indexOf(m), h < 0 && (h = s.activeIndex - 1), "auto" === i.slidesPerView && 1 === i.slidesPerGroup && i.slidesPerGroupAuto && (h = h - s.slidesPerViewDynamic("previous", !0) + 1, h = Math.max(h, 0))), s.slideTo(h, e, t, n)
            },
            ...
            slideToClickedSlide: function () {
                ...
                if (t.loop) {
                    ...
                    i = parseInt(h(e.clickedSlide).attr("data-swiper-slide-index"), 10), t.centeredSlides ? r < e.loopedSlides - s / 2 || r > e.slides.length - e.loopedSlides + s / 2 ? (e.loopFix(), r = n.children(`.${t.slideClass}[data-swiper-slide-index="${i}"]:not(.${t.slideDuplicateClass})`).eq(0).index(), f((() => {
                        e.slideTo(r)
                    }))) : e.slideTo(r) : r > e.slides.length - s ? (e.loopFix(), r = n.children(`.${t.slideClass}[data-swiper-slide-index="${i}"]:not(.${t.slideDuplicateClass})`).eq(0).index(), f((() => {
                        e.slideTo(r)
                    }))) : e.slideTo(r)
                } else e.slideTo(r)
            }
        ...
        function I(e) {
            ...
            if (Object.assign(r, {
                    ...
                    isScrolling: void 0,
                    startMoving: void 0
                }), l.startX = f, l.startY = v, r.touchStartTime = g(), t.allowClick = !0, t.updateSize(), t.swipeDirection = void 0, a.threshold > 0 && (r.allowThresholdMove = !1), "touchstart" !== d.type) {
                let e = !0;
        ...
        function j(e) {
            ...
            if (void 0 === s.isScrolling) {
                let e;
                n.isHorizontal() && o.currentY === o.startY || n.isVertical() && o.currentX === o.startX ? s.isScrolling = !1 : m * m + f * f >= 25 && (e = 180 * Math.atan2(Math.abs(f), Math.abs(m)) / Math.PI, s.isScrolling = n.isHorizontal() ? e > r.touchAngle : 90 - e > r.touchAngle)
            }
            ...
            let b = !0,
                w = r.resistanceRatio;
            if (r.touchReleaseOnEdges && (w = 0), v > 0 && s.currentTranslate > n.minTranslate() ? (b = !1, r.resistance && (s.currentTranslate = n.minTranslate() - 1 + (-n.minTranslate() + s.startTranslate + v) ** w)) : v < 0 && s.currentTranslate < n.maxTranslate() && (b = !1, r.resistance && (s.currentTranslate = n.maxTranslate() + 1 - (n.maxTranslate() - s.startTranslate - v) ** w)), b && (c.preventedByNestedSwiper = !0), !n.allowSlideNext && "next" === n.swipeDirection && s.currentTranslate < s.startTranslate && (s.currentTranslate = s.startTranslate), !n.allowSlidePrev && "prev" === n.swipeDirection && s.currentTranslate > s.startTranslate && (s.currentTranslate = s.startTranslate), n.allowSlidePrev || n.allowSlideNext || (s.currentTranslate = s.startTranslate), r.threshold > 0) {
        ...
        const G = (e, t) => {
            ...
            (s.preventClicks || s.preventClicksPropagation) && o[u]("click", e.onClick, !0), s.cssMode && a[u]("scroll", e.onScroll), s.updateOnWindowResize ? e[p](l.ios || l.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", z, !0) : e[p]("observerUpdate", z, !0)
        };
        const V = {
                attachEvents: function () {
                    ...
                    e.onTouchStart = I.bind(e), e.onTouchMove = j.bind(e), e.onTouchEnd = D.bind(e), n.cssMode && (e.onScroll = N.bind(e)), e.onClick = _.bind(e), s.touch && !q && (t.addEventListener("touchstart", H), q = !0), G(e, "on")
                },
        ...
        class Z {
            constructor(...e) {
                ...
                const r = w({}, Y, i);
                return s.params = w({}, r, K, n), s.originalParams = w({}, s.params), s.passedParams = w({}, n), s.params && s.params.on && Object.keys(s.params.on).forEach((e => {
        ...
        Object.keys(X).forEach((e => {
            ...
            t("init", (() => {
                ...
                })), i.observe(e.el)) : (s.addEventListener("resize", r), s.addEventListener("orientationchange", a))
            })), t("destroy", (() => {
        ...
        J.use([function ({
            ...
            function o() {
                ...
                t.attr("data-swiper-autoplay") && (n = t.attr("data-swiper-autoplay") || e.params.autoplay.delay), clearTimeout(r), r = f((() => {
                    let t;
        ...
        document.addEventListener("DOMContentLoaded", (function () {
            ie(".reviews_slider--media", pe(pe({}, fe), {}, {
                watchSlidesProgress: !0
            })), ie(".reviews_slider--main", pe(pe({}, fe), {}, {
